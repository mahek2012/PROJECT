...
import { Mail, Lock, LogIn, ArrowRight, AlertCircle, ShoppingCart } from 'lucide-react';
...
const Login = () => {
  ...
  }, [token, user, navigate, from, dispatch]);
    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      >
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
          <p className="text-xs font-bold text-orange-700 mb-2 uppercase tracking-wider">🔑 Admin Login</p>
          <div className="flex items-center justify-between gap-3">
            <div className="text-xs text-orange-600 font-mono">
              <p>admin@shopverse.com</p>
              <p>adminpassword123</p>
            </div>
            <button
              type="button"
              onClick={() => setFormData({ email: 'admin@shopverse.com', password: 'adminpassword123' })}
              className="shrink-0 text-xs bg-orange-500 hover:bg-orange-600 text-white font-bold px-4 py-2 rounded-lg transition-colors"
            >
              Auto Fill
            </button>
          </div>
